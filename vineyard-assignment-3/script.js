/** 
 * Vineyard Assignment 3 — UI glue and small algorithms.
 * Hand-edited: added comments and clearer local names for readability.
 * Note: keeps all DOM `id` values intact so behavior doesn't change.
 */
...
// Cache DOM nodes in a friendly object
const dom = {
...
/**
 * findSecondLargest
 * Single-pass solution — does not sort the array.
 * Returns second largest number or null when not available.
 */
...
// parse a comma-separated input into numbers (for task 2)
